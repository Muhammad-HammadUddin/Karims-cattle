  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fontSize(10)
        .text("KARIM'S CATTLE FARM", left, 40, { characterSpacing: 1.5 });
      ...
      doc
        .fontSize(8)
        .fillColor(MUTED)
        .text(`Generated on ${fmtDate(new Date())} · Karim's Cattle Farm`, left, doc.page.height - 50, {
          width: pageWidth,
          align: "center",
        });
